...
export function TrustStrip() {
    return (
        <section className="bg-white py-12 border-y border-slate-100">
            <div className="max-w-7xl mx-auto px-6 lg:px-10 flex flex-wrap justify-between gap-8 md:gap-12">
                {TRUST_BADGES.map((badge) => (
                    <div key={badge.title} className="flex items-center gap-4 flex-1 min-w-[200px]">
